    ...
    def __init__(self, filename):
        ...
        if self.fversn == b"\x4b":
            ...
            if not self.txyxys:
                ...
                if self.txvals:
                    ...
                    self.x = np.array(
                        [
                            struct.unpack_from("f", content[x_dat_pos:x_dat_end], 4 * i)[0]
        ...
        # --------------------------------------------
            ...
            (
                ...
                self.ocatxt,
                self.osubh1,
            ) = struct.unpack(self.old_head_str.encode("utf8"), content[: self.old_head_siz])
            ...
            while True:
                try:
                    ...
                    self.sub.append(
                        subFileOld(content[sub_pos:sub_end], pts, self.oexp, self.txyxys)
                    )
